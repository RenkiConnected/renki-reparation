...
const DEFAULT_BRANDS = [
 ...
 },
 {
   ...
   models:[
     {id:uid(),name:"Galaxy S26 Ultra",   order:1,  prices:pr(519,309,129,85,199,109,239)},
     {id:uid(),name:"Galaxy S26+",        order:2,  prices:pr(449,269,109,75,169,95,209)},
     {id:uid(),name:"Galaxy S26",         order:3,  prices:pr(379,239,95,69,149,85,179)},
     {id:uid(),name:"Galaxy S26 FE",      order:4,  prices:pr(299,199,85,65,119,75,149)},
     {id:uid(),name:"Galaxy S25 Ultra",   order:5,  prices:pr(489,289,119,79,189,99,229)},
     {id:uid(),name:"Galaxy S25+",        order:6,  prices:pr(419,259,99,69,159,89,199)},
     {id:uid(),name:"Galaxy S25",         order:7,  prices:pr(359,229,89,65,139,79,169)},
     {id:uid(),name:"Galaxy S24 Ultra",   order:8,  prices:pr(459,279,109,75,179,95,219)},
     {id:uid(),name:"Galaxy S24+",        order:9,  prices:pr(389,249,99,69,149,85,189)},
     {id:uid(),name:"Galaxy S24",         order:10, prices:pr(329,219,89,65,129,75,159)},
     {id:uid(),name:"Galaxy S24 FE",      order:11, prices:pr(279,189,79,59,109,65,139)},
     {id:uid(),name:"Galaxy S23 Ultra",   order:12, prices:pr(419,259,99,69,169,89,199)},
     {id:uid(),name:"Galaxy S23+",        order:13, prices:pr(349,219,89,65,139,79,169)},
     {id:uid(),name:"Galaxy S23",         order:14, prices:pr(299,199,79,59,119,69,149)},
     {id:uid(),name:"Galaxy S23 FE",      order:15, prices:pr(249,169,69,55,99,59,129)},
     {id:uid(),name:"Galaxy S22 Ultra",   order:16, prices:pr(379,239,89,65,159,85,189)},
     {id:uid(),name:"Galaxy S22+",        order:17, prices:pr(309,199,79,59,129,75,159)},
     {id:uid(),name:"Galaxy S22",         order:18, prices:pr(269,179,69,55,109,65,139)},
     {id:uid(),name:"Galaxy S21 Ultra",   order:19, prices:pr(349,219,79,59,149,79,179)},
     {id:uid(),name:"Galaxy S21+",        order:20, prices:pr(279,189,69,55,119,69,149)},
     {id:uid(),name:"Galaxy S21",         order:21, prices:pr(239,169,65,49,99,59,129)},
     {id:uid(),name:"Galaxy S21 FE",      order:22, prices:pr(199,149,59,49,89,55,119)},
     {id:uid(),name:"Galaxy S20 Ultra",   order:23, prices:pr(319,199,79,55,139,75,169)},
     {id:uid(),name:"Galaxy S20+",        order:24, prices:pr(259,169,65,49,109,65,139)},
     {id:uid(),name:"Galaxy S20",         order:25, prices:pr(219,149,59,45,89,59,119)},
     {id:uid(),name:"Galaxy S20 FE",      order:26, prices:pr(179,129,55,45,79,55,109)},
     {id:uid(),name:"Galaxy Z Fold 7",    order:27, prices:pr(749,null,159,109,269,139,289)},
     {id:uid(),name:"Galaxy Z Fold 6",    order:28, prices:pr(699,null,149,99,249,129,269)},
     {id:uid(),name:"Galaxy Z Fold 5",    order:29, prices:pr(649,null,139,99,229,119,249)},
     {id:uid(),name:"Galaxy Z Fold 4",    order:30, prices:pr(599,null,129,89,209,109,229)},
     {id:uid(),name:"Galaxy Z Fold 3",    order:31, prices:pr(549,null,119,89,189,99,209)},
     {id:uid(),name:"Galaxy Z Flip 7",    order:32, prices:pr(419,null,129,85,189,105,199)},
     {id:uid(),name:"Galaxy Z Flip 7 FE", order:33, prices:pr(329,null,109,75,159,89,169)},
     {id:uid(),name:"Galaxy Z Flip 6",    order:34, prices:pr(389,null,119,79,179,99,189)},
     {id:uid(),name:"Galaxy Z Flip 5",    order:35, prices:pr(359,null,109,75,159,89,169)},
     {id:uid(),name:"Galaxy Z Flip 4",    order:36, prices:pr(319,null,99,69,139,79,149)},
     {id:uid(),name:"Galaxy Z Flip 3",    order:37, prices:pr(289,null,89,65,119,75,139)},
     {id:uid(),name:"Galaxy A56",         order:38, prices:pr(209,149,63,53,93,63,113)},
     {id:uid(),name:"Galaxy A55",         order:39, prices:pr(199,139,59,49,89,59,109)},
     {id:uid(),name:"Galaxy A54",         order:40, prices:pr(179,129,55,45,79,55,99)},
     {id:uid(),name:"Galaxy A53",         order:41, prices:pr(159,109,49,39,69,49,89)},
     {id:uid(),name:"Galaxy A52s",        order:42, prices:pr(155,105,47,37,67,47,87)},
     {id:uid(),name:"Galaxy A52",         order:43, prices:pr(149,99,45,35,65,45,85)},
     {id:uid(),name:"Galaxy A36",         order:44, prices:pr(169,119,51,41,71,51,91)},
     {id:uid(),name:"Galaxy A35",         order:45, prices:pr(159,109,49,39,69,49,89)},
     {id:uid(),name:"Galaxy A34",         order:46, prices:pr(149,99,45,39,65,45,85)},
     {id:uid(),name:"Galaxy A33",         order:47, prices:pr(139,95,43,37,61,43,83)},
     {id:uid(),name:"Galaxy A32",         order:48, prices:pr(129,89,41,35,57,41,79)},
     {id:uid(),name:"Galaxy A26",         order:49, prices:pr(139,95,43,37,61,43,83)},
     {id:uid(),name:"Galaxy A25",         order:50, prices:pr(129,89,39,35,55,39,75)},
     {id:uid(),name:"Galaxy A24",         order:51, prices:pr(119,85,37,33,51,37,71)},
     {id:uid(),name:"Galaxy A23",         order:52, prices:pr(109,79,35,29,47,35,67)},
     {id:uid(),name:"Galaxy A16",         order:53, prices:pr(119,85,41,35,53,41,71)},
     {id:uid(),name:"Galaxy A15",         order:54, prices:pr(109,79,39,35,49,39,69)},
     {id:uid(),name:"Galaxy A14",         order:55, prices:pr(99,69,35,29,45,35,65)},
     {id:uid(),name:"Galaxy A13",         order:56, prices:pr(89,65,33,27,41,33,61)},
     {id:uid(),name:"Galaxy A06s",        order:57, prices:pr(89,64,31,25,41,31,59)},
     {id:uid(),name:"Galaxy A06",         order:58, prices:pr(85,62,30,24,39,30,57)},
     {id:uid(),name:"Galaxy A05s",        order:59, prices:pr(85,62,30,25,39,30,57)},
     {id:uid(),name:"Galaxy A05",         order:60, prices:pr(79,55,29,23,37,29,55)},
     {id:uid(),name:"Galaxy A04s",        order:61, prices:pr(79,55,28,22,36,28,53)},
     {id:uid(),name:"Galaxy A04e",        order:62, prices:pr(73,50,26,20,33,26,49)},
     {id:uid(),name:"Galaxy A04",         order:63, prices:pr(75,52,27,21,35,27,51)},
     {id:uid(),name:"Galaxy A03s",        order:64, prices:pr(75,52,27,21,35,27,51)},
     {id:uid(),name:"Galaxy A03",         order:65, prices:pr(69,49,25,19,33,25,49)},
     {id:uid(),name:"Galaxy A10e",        order:66, prices:pr(69,49,25,19,33,25,49)},
     {id:uid(),name:"Galaxy A10s",        order:67, prices:pr(75,52,27,21,35,27,51)},
     {id:uid(),name:"Galaxy A10",         order:68, prices:pr(79,55,29,23,37,29,55)},
   ]
 },
 {
